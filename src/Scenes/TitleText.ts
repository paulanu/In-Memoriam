...
export default class TitleText extends Phaser.Scene {
    ...
    backTextObject: Phaser.GameObjects.Text;
    flashingTextObject: Phaser.GameObjects.Text;

    startingHeight: number = 50;
    currentLine: number = 0;
    currentYPos: number; //keep track of position in space
	textVerticalSpacing: number = 50; //how far apart text should be
	backTextOffsetHeight: number = 2; //offset backtext from regular text for visual effect
